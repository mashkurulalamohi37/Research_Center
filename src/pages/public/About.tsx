  ...
  return (
    <div className="py-12 space-y-24">
      ...
      <section className="container mx-auto px-4 lg:px-8 text-center max-w-4xl">
        ...
        <p className="text-slate-300 text-base sm:text-lg mt-6 leading-relaxed max-w-3xl mx-auto">
      ...
      <section className="container mx-auto px-4 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <Card className="p-8 border-slate-800 bg-slate-900/60 hover:border-cyan-500/40 transition-all space-y-4">
          ...
          <Card className="p-8 border-slate-800 bg-slate-900/60 hover:border-cyan-500/40 transition-all space-y-4">
            ...
            <h3 className="text-xl font-bold text-slate-100">Research Philosophy</h3>
            <p className="text-sm text-slate-400 leading-relaxed">
      ...
      {/* Director's Message (Section 22) */}
      <section className="container mx-auto px-4 lg:px-8">
        <div className="p-8 sm:p-12 rounded-3xl border border-cyan-500/30 bg-slate-900/80 backdrop-blur-xl shadow-2xl relative overflow-hidden">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
            <div className="lg:col-span-4 text-center lg:text-left">
              ...
              <h4 className="text-xl font-extrabold text-slate-100">Prof. Dr. Sarah Lin</h4>
              <p className="text-xs text-cyan-400 font-mono font-medium">Founding Director & Chief Scientist</p>
              <p className="text-xs text-slate-400 mt-1">IEEE & ACM Fellow • Ph.D. Stanford</p>
            </div>
      ...
      <section className="container mx-auto px-4 lg:px-8 max-w-4xl">
        ...
        <div className="space-y-8 relative before:absolute before:inset-0 before:left-1/2 before:-translate-x-1/2 before:w-0.5 before:bg-slate-800">
          <div className="relative flex flex-col md:flex-row items-center justify-between gap-6">
            <div className="w-full md:w-5/12 p-6 rounded-2xl border border-slate-800 bg-slate-900/70 text-right">
              <span className="text-xs font-mono text-cyan-400 font-bold">2020</span>
              <h4 className="text-base font-bold text-slate-100 mt-1">Founding of AIRC</h4>
              <p className="text-xs text-slate-400 mt-1">Established with an initial $25M founding grant to explore neuro-symbolic reasoning and AI safety.</p>
            </div>
            <div className="w-8 h-8 rounded-full bg-cyan-400 text-navy-950 flex items-center justify-center font-bold text-xs shrink-0 z-10 shadow-lg shadow-cyan-400/30">
              1
            </div>
          ...
          <div className="relative flex flex-col md:flex-row items-center justify-between gap-6">
            ...
            <div className="w-full md:w-5/12 p-6 rounded-2xl border border-slate-800 bg-slate-900/70 text-left">
              <span className="text-xs font-mono text-cyan-400 font-bold">2022</span>
              <h4 className="text-base font-bold text-slate-100 mt-1">Expansion into Embodied Robotics</h4>
              <p className="text-xs text-slate-400 mt-1">Launched the High-Bay Robotics Pavilion and initiated DARPA swarm subterranean challenge partnerships.</p>
            </div>
          </div>

          <div className="relative flex flex-col md:flex-row items-center justify-between gap-6">
            <div className="w-full md:w-5/12 p-6 rounded-2xl border border-slate-800 bg-slate-900/70 text-right">
              <span className="text-xs font-mono text-cyan-400 font-bold">2024</span>
              <h4 className="text-base font-bold text-slate-100 mt-1">Nature Chemical Biology Drug Discovery</h4>
              <p className="text-xs text-slate-400 mt-1">Synthesized 18 novel small molecules with selective oncogenic KRAS-G12D mutation affinity.</p>
            </div>
            <div className="w-8 h-8 rounded-full bg-cyan-400 text-navy-950 flex items-center justify-center font-bold text-xs shrink-0 z-10 shadow-lg shadow-cyan-400/30">
              3
            </div>
          ...
          <div className="relative flex flex-col md:flex-row items-center justify-between gap-6">
            ...
            <div className="w-full md:w-5/12 p-6 rounded-2xl border border-cyan-500/40 bg-slate-900/90 text-left shadow-lg shadow-cyan-950/30">
              <span className="text-xs font-mono text-cyan-400 font-bold">2025–2026</span>
              <h4 className="text-base font-bold text-cyan-300 mt-1">NeuroLogic-v2 & Clinical Trials</h4>
              <p className="text-xs text-slate-300 mt-1">Open-source release of NeuroLogic-v2 foundation model and multi-center hospital clinical trials for LaproSplat 3D surgical guidance.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="container mx-auto px-4 lg:px-8">
        <div className="p-8 rounded-3xl border border-slate-800 bg-slate-950/60 text-center max-w-4xl mx-auto space-y-6">
          <Badge variant="cyan">Governance</Badge>
          <h3 className="text-2xl font-bold text-slate-100">Institutional Governance & Advisory</h3>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 pt-4 text-xs font-semibold text-slate-300">
