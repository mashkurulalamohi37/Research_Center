...
export const ResearcherLayout: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-navy-950 flex">
      ...
      {/* Sidebar */}
      <aside
        className={`fixed lg:static top-0 bottom-0 left-0 z-50 w-64 bg-slate-950/95 border-r border-slate-800/80 flex flex-col justify-between p-4 transition-transform duration-300 ${
        ...
        <div className="pt-4 border-t border-slate-800/80 space-y-3">
          <div className="flex items-center gap-3 px-2">
            ...
            <div className="flex-1 min-w-0">
              ...
              <div className="text-[10px] text-cyan-400 font-mono truncate">{user?.title || 'Lead Investigator'}</div>
            </div>
          </div>
